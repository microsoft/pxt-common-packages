namespace pins {
    ...
    //% blockId=pins_i2c_readnumber block="i2c read number at address %address|of format %format||repeated %repeat"
    ...
    //% blockId=i2c_writenumber block="i2c write number|at address %address|with value %value|of format %format||repeated %repeat"

/**
 * Box2D 2.4.1 physics. Native objects are opaque garbage-collected references.
...
namespace box2dNative {
    /** Opaque native object managed by the MakeCode garbage collector. */
    export interface Handle {
        __box2dNativeHandle: any;
    }

    /** Create an independently owned physics world. Positive Y gravity points down. */
    // Native wrapper: box2dNative::createWorld
    export function createWorld(gravityX: number = 0, gravityY: number = 9.8): Handle {
    ...
    export function destroyWorld(world: Handle): void {
    ...
    export function isValid(handle: Handle): boolean {
    ...
    export function setGravity(world: Handle, x: number, y: number): void {
    ...
    export function step(world: Handle, seconds: number = 0.016666666666666666, velocityIterations: number = 8, positionIterations: number = 3): void {
    ...
    export function setWorldSleepingAllowed(world: Handle, allowed: boolean): void {
    ...
    export function createBody(world: Handle, type: box2d.BodyType, x: number = 0, y: number = 0, angle: number = 0): Handle {
    ...
    export function destroyBody(body: Handle): void {
    ...
    export function getBodyState(body: Handle): number[] {
    ...
    export function readBodyTransform(body: Handle, output: number[]): void {
    ...
    export function applyForce(body: Handle, x: number, y: number, pointX: number, pointY: number, wake: boolean = true): void {
        box2dNativeShim.applyForce([body, x, y, pointX, pointY, wake ? 1 : 0]);
    }

    // Native wrapper: box2dNative::applyForceToCenter
    export function applyForceToCenter(body: Handle, x: number, y: number, wake: boolean = true): void {
    ...
    export function applyLinearImpulse(body: Handle, x: number, y: number, pointX: number, pointY: number, wake: boolean = true): void {
        box2dNativeShim.applyLinearImpulse([body, x, y, pointX, pointY, wake ? 1 : 0]);
    }

    // Native wrapper: box2dNative::applyLinearImpulseToCenter
    export function applyLinearImpulseToCenter(body: Handle, x: number, y: number, wake: boolean = true): void {
        box2dNativeShim.applyLinearImpulseToCenter(body, x, y, wake);
    }

    // Native wrapper: box2dNative::applyTorque
    export function applyTorque(body: Handle, torque: number, wake: boolean = true): void {
        box2dNativeShim.applyTorque(body, torque, wake);
    }

    // Native wrapper: box2dNative::applyAngularImpulse
    export function applyAngularImpulse(body: Handle, impulse: number, wake: boolean = true): void {
    ...
    export function getWorldPoint(body: Handle, x: number, y: number): number[] {
    ...
    export function getLocalPoint(body: Handle, x: number, y: number): number[] {
    ...
    export function createCircleShape(radius: number, centerX: number = 0, centerY: number = 0): Handle {
    ...
    export function createBoxShape(halfWidth: number, halfHeight: number, centerX: number = 0, centerY: number = 0, angle: number = 0): Handle {
    ...
    export function createPolygonShape(vertices: number[]): Handle {
    ...
    export function createEdgeShape(x1: number, y1: number, x2: number, y2: number): Handle {
    ...
    export function createChainShape(vertices: number[], loop: boolean = false): Handle {
    ...
    export function destroyShape(shape: Handle): void {
    ...
    export function createFixture(body: Handle, shape: Handle, density: number = 1, friction: number = 0.2, restitution: number = 0, sensor: boolean = false): Handle {
    ...
    export function destroyFixture(fixture: Handle): void {
        box2dNativeShim.destroyFixture(fixture);
    }

    // Native wrapper: box2dNative::getFixtureBody
    export function getFixtureBody(fixture: Handle): Handle {
    ...
    export function setFixtureMaterial(fixture: Handle, density: number, friction: number, restitution: number): void {
        box2dNativeShim.setFixtureMaterial(fixture, density, friction, restitution);
    }

    // Native wrapper: box2dNative::setFixtureSensor
    export function setFixtureSensor(fixture: Handle, sensor: boolean): void {
    ...
    export function setFixtureFilter(fixture: Handle, categoryBits: number = 1, maskBits: number = 65535, groupIndex: number = 0): void {
    ...
    export function testPoint(fixture: Handle, x: number, y: number): boolean {
    ...
    export function createDistanceJoint(bodyA: Handle, bodyB: Handle, anchorAX: number, anchorAY: number, anchorBX: number, anchorBY: number, collideConnected: boolean = false): Handle {
    ...
    export function setDistanceJoint(joint: Handle, length: number, minLength: number, maxLength: number, stiffness: number = 0, damping: number = 0): void {
    ...
    export function createRevoluteJoint(bodyA: Handle, bodyB: Handle, anchorX: number, anchorY: number, collideConnected: boolean = false): Handle {
    ...
    export function setRevoluteJointMotor(joint: Handle, enabled: boolean, speed: number, maxTorque: number): void {
    ...
    export function setRevoluteJointLimits(joint: Handle, enabled: boolean, lower: number, upper: number): void {
    ...
    export function createWheelJoint(bodyA: Handle, bodyB: Handle, anchorX: number, anchorY: number, axisX: number, axisY: number, collideConnected: boolean = false): Handle {
    ...
    export function setWheelJointMotor(joint: Handle, enabled: boolean, speed: number, maxTorque: number): void {
    ...
    export function setWheelJointLimits(joint: Handle, enabled: boolean, lower: number, upper: number): void {
    ...
    export function setWheelJointSuspension(joint: Handle, stiffness: number, damping: number): void {
    ...
    export function createMouseJoint(bodyA: Handle, bodyB: Handle, anchorX: number, anchorY: number, maxForce: number, stiffness: number, damping: number): Handle {
    ...
    export function setMouseJointTarget(joint: Handle, x: number, y: number): void {
    ...
    export function getContacts(world: Handle): Handle[] {
    ...
    export function queryAABB(world: Handle, minX: number, minY: number, maxX: number, maxY: number): Handle[] {
    ...
    export function rayCast(world: Handle, x1: number, y1: number, x2: number, y2: number): any[] {

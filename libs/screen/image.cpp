...
static int shade(const Vec2& area, const Vertex* V0, const Vertex* V1, const Vertex* V2, const Vec3& bary, Image_ tex) {
...
static void drawTri(const Vertex* verts[], const int indices[], const Vec2& area, Image_ dst, Image_ tex) {
...
void _drawQuad(Image_ dst, Image_ tex, RefCollection *args) {
    GpuMethods::drawQuad(dst, tex, args);
}
